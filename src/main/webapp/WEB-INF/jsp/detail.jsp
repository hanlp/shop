...
<script type="text/javascript" src="<%=request.getContextPath() %>/js/jquery_002.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/js/jquery_004.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/js/jquery_003.js"></script>
