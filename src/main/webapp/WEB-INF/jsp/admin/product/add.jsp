...
<HTML>
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/product/saveProduct" method="post" enctype="multipart/form-data">
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="shopPrice" value="" id="logonPwd"/>
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">
						市场价格：
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="marketPrice" value="" id="userAction_save_do_userName" class="bg"/>
					</td>
				</tr>
				<tr>
					<td align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff">
						...
						<select name="csid" >
						   	   <option value="1">羊毛大衣</option>
						       <option value="2">羽绒服</option>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						<input type="file" name="picFile" size="30" value="" id="userAction_save_do_upload"/>
					</td>
				</tr>
				<TR>
